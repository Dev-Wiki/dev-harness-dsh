...
## 项目简介
dev-harness-dsh 把 Audit、Auto Fix、验证、QA 与最终复核编排为可恢复运行；V0、K1、K2、K3、K4 已完成，当前进入 Full Verification
...
## 核心模块
- src — 生产 Plugin、Human Command、Run Authorization、Audit/Auto Fix Adapter、可恢复 Orchestrator 与原子 Run State
- tests — 生产生命周期、命令、授权、CompletionStatus、提交边界、漂移和恢复自动化
